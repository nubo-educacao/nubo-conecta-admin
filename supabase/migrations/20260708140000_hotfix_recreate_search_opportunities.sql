-- 20260708140000_hotfix_recreate_search_opportunities.sql
--
-- HOTFIX: A migration 20260708120000 falhou antes de recriar as funções.
-- Estado real do banco após a falha:
--   ✅  v_unified_opportunities: existe e populada MAS sem coluna search_text
--   ❌  search_opportunities: foi dropada e não foi recriada → erro "column does not exist"
--   ✅  get_unified_opportunities_by_distance: existe com shape antigo (sem search_text)
--   ❌  idx_v_unified_opportunities_search_text: não existe
--   ❌  uq_v_unified_opportunities_id_type: não existe
--
-- Estratégia:
--   1. DROP + CREATE da matview com search_text
--   2. Recria índices (incluindo GIN em search_text)
--   3. Recria search_opportunities e get_unified_opportunities_by_distance
--   4. REFRESH da matview (CONCURRENTLY — índice único já criado)
--   5. Recria v_unified_institutions
-- ====================================================================================

-- ====================================================================================
-- 0. Remove dependências diretas EXPLICITAMENTE
-- ====================================================================================
...
-- ====================================================================================
-- 4. get_unified_opportunities_by_distance (com search_text no RETURNS TABLE)
-- ====================================================================================
...
-- ====================================================================================
-- 5. REFRESH (CONCURRENTLY — índice único já criado acima)
-- ====================================================================================
REFRESH MATERIALIZED VIEW CONCURRENTLY public.v_unified_opportunities;

-- ====================================================================================
-- 6. Recria v_unified_institutions
-- ====================================================================================
