-- =============================================================================
-- Migration: v_unified_opportunities — Sprint 11.0 Card 9.3.1 T2
-- Atualizar filtro do branch Parceiro:
--   WHERE po.status = 'approved' → WHERE po.status IN ('incoming', 'opened', 'closed')
-- =============================================================================
