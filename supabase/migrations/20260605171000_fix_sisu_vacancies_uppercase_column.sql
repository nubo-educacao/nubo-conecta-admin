-- Fix casing for NU_PERC_I column in etl_import_sisu_vacancies
-- 20260605171000_fix_sisu_vacancies_uppercase_column.sql
    ...
    BEGIN
      ...
      IF v_opp_id IS NOT NULL THEN
        ...
        VALUES (
          ...
          COALESCE(NULLIF(v_rec."PESO_REDACAO", ''), '0')::numeric,
          COALESCE(NULLIF(v_rec."NOTA_MINIMA_REDACAO", ''), '0')::numeric,
          COALESCE(NULLIF(v_rec."PESO_LINGUAGENS", ''), '0')::numeric,
          COALESCE(NULLIF(v_rec."NOTA_MINIMA_LINGUAGENS", ''), '0')::numeric,
          COALESCE(NULLIF(v_rec."PESO_MATEMATICA", ''), '0')::numeric,
          COALESCE(NULLIF(v_rec."NOTA_MINIMA_MATEMATICA", ''), '0')::numeric,
          COALESCE(NULLIF(v_rec."PESO_CIENCIAS_HUMANAS", ''), '0')::numeric,
          COALESCE(NULLIF(v_rec."NOTA_MINIMA_CIENCIAS_HUMANAS", ''), '0')::numeric,
          COALESCE(NULLIF(v_rec."PESO_CIENCIAS_NATUREZA", ''), '0')::numeric,
          COALESCE(NULLIF(v_rec."NOTA_MINIMA_CIENCIAS_NATUREZA", ''), '0')::numeric,
          COALESCE(NULLIF(v_rec."NU_MEDIA_MINIMA_ENEM", ''), '0')::numeric,
