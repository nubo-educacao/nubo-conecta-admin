-- Migration: Restore website_url to v_unified_institutions
-- 20260602150000_restore_website_url_to_v_unified_institutions.sql
-- Fixes regression from 20260602100000_v_unified_opportunities_with_lat_long.sql
-- which overwrote v_unified_institutions view without the pi.website_url column.
