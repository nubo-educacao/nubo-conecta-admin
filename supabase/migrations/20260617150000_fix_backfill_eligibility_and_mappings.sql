-- fix_backfill_eligibility_and_mappings.sql
-- ==========================================
    ...
    BEGIN
      ...
      LOOP
        ...
        IF v_field.is_criterion AND v_field.criterion_rule IS NOT NULL THEN
          v_met := FALSE;
          BEGIN
            -- Simple check: if answer exists, treat as met
      ...
      -- Update user_profiles with eligibility_results and direct field mappings
