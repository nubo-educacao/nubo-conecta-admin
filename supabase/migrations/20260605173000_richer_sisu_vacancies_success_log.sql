-- Richer success logging for etl_import_sisu_vacancies
-- 20260605173000_richer_sisu_vacancies_success_log.sql
--
-- Enriquece a mensagem de sucesso com contagens reais da tabela destino:
--   • Total de registros em opportunities_sisu_vacancies para o ciclo
--   • Oportunidades do ciclo que receberam dados de vaga
--   • Oportunidades do ciclo sem dados de vaga (sem vinculação no rawsisuvacancies)
--   • Vagas com dados históricos propagados do ano anterior
...
BEGIN
  ...
  -- Total registros em opportunities_sisu_vacancies vinculados ao ciclo
