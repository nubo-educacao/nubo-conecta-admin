-- Fix numeric casting for comma decimal separator in etl_import_sisu
-- Replaces raw NU_NOTACORTE with REPLACE formatting to handle Portuguese decimal commas (e.g., "589,54" -> 589.54)
