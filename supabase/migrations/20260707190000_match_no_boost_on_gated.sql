-- 20260707190000_match_no_boost_on_gated.sql
-- Reproduz calculate_match(uuid) da 20260707160000 com 1 correção:
--   Boost sobre oportunidade GATEADA: o gate de ENEM<450 do ProUni zera o base_score na
--   CTE composite, mas a CTE boosted só re-checava meets_income antes de somar os boosts
--   (+5 vagas ociosas, +10 cota) — oportunidades inelegíveis escapavam com score 15 em vez
--   de 0, achatando o ranking (todos empatados; interesse de curso sem efeito) e exibindo
--   matches para usuários inelegíveis. Agora: base_score <= 0 (qualquer gate) => 0, sem boost.
