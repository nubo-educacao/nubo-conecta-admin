-- 20260706120000_prouni_grain_and_null_cutoff.sql
-- Plan v2 (61b505ce) — Cards 1 & 2.
-- Card 1: grão do ETL ProUni passa a incluir scholarship_type (Integral vs Parcial)
--         — no DISTINCT ON, nos predicados UPDATE/NOT EXISTS e no JOIN de vagas.
-- Card 2: ProUni não terá nota de corte neste ciclo — o ETL para de gravar cutoff_score
--         (NULL) e zeramos o cutoff_score dos ProUni já existentes.

-- ====================================================================================
-- 1. etl_import_prouni — grão (curso, turno, tipo_bolsa) + cutoff_score NULL
-- ====================================================================================
...
-- ====================================================================================
-- 2. Card 2 — zerar cutoff_score dos ProUni já existentes + refresh da matview
-- ====================================================================================
UPDATE public.opportunities
SET cutoff_score = NULL, updated_at = now()
WHERE opportunity_type = 'prouni' AND cutoff_score IS NOT NULL;
