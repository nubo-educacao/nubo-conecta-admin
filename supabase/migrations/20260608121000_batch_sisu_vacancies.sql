-- Add batch processing to SiSU Vacancies ETL
-- 20260608121000_batch_sisu_vacancies.sql
...
BEGIN
      ...
      IF v_course_id IS NOT NULL THEN
        ...
        IF v_opp_id IS NOT NULL THEN
          INSERT INTO public.opportunities_sisu_vacancies (
            ...
            peso_redacao, nota_minima_redacao, peso_linguagens, nota_minima_linguagens,
            peso_matematica, nota_minima_matematica, peso_ciencias_humanas, nota_minima_ciencias_humanas,
          ...
          VALUES (
            v_opp_id,
            v_rec."QT_SEMESTRE", v_rec."NU_VAGAS_AUTORIZADAS", v_rec."QT_VAGAS_OFERTADAS",
            v_rec."NU_PERCENTUAL_BONUS", v_rec."TP_MOD_CONCORRENCIA", v_rec."TP_COTA", v_rec."DS_MOD_CONCORRENCIA",
            ...
            v_rec."PERC_UF_IBGE_PPI", v_rec."PERC_UF_IBGE_PP", v_rec."PERC_UF_IBGE_I", v_rec."PERC_UF_IBGE_Q", v_rec."PERC_UF_IBGE_PCD",
            v_rec."NU_PERC_LEI", v_rec."NU_PERC_PPI", v_rec."NU_PERC_PP", v_rec."NU_PERC_I", v_rec."NU_PERC_Q", v_rec."NU_PERC_PCD"
          )
  ...
  -- Determine if we have more rows
  IF p_limit IS NOT NULL AND v_processed = p_limit THEN
    v_has_more := TRUE;
  END IF;

  -- Update log records processed
  ...
  -- Only do historical propagation and rich stats on the FINAL batch
  IF NOT v_has_more THEN
    ...
    IF v_errors IS NULL THEN
      v_detail_msg :=
        ...
        chr(10) || '• Vagas vinculadas (mapeadas):    ' || v_total_processed_in_log ||
