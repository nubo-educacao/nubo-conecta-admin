-- 20260609204736_fix_rollback_fully_imported_flag.sql
-- Updates etl_rollback_log to reset is_fully_imported to false in the programs table for any program rollback.
