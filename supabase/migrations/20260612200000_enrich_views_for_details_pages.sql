-- Migration: enrich views for details pages
-- Description: Recreates v_unified_opportunities and v_unified_institutions to expose additional columns:
--              For institutions: igc, ci, ci_ead, legal_nature, maintainer_name
--              For opportunities: nu_media_minima_enem_current, nu_media_minima_enem_prev
...
-- 2. Recreate v_unified_opportunities Materialized View
...
-- 3. Recreate public.v_unified_institutions with expanded EMEC columns
...
-- 4. Recreate public.get_unified_opportunities_by_distance helper function
