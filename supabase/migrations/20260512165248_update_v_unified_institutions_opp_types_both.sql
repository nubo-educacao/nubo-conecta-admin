-- Migration: update_v_unified_institutions_opp_types_both
-- Sprint 8.0: Atualizar view para retornar opportunity_type ordernado por frequência, incluindo partner_opportunities.
...
opp_counts AS (
    SELECT 
        ...
        COUNT(*) as freq
    FROM all_opps
    GROUP BY institution_id, opportunity_type
),
inst_opps AS (
    SELECT 
        institution_id,
