-- Fix etl_import_sisu bulk insertion logic
-- Replaces the incorrect campus and course insertion mappings and prevents "ON CONFLICT DO UPDATE command cannot affect row a second time"
