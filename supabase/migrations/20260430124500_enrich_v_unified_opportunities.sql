-- Migration: Enriquecimento de v_unified_opportunities (Materialized Fix + Subtypes)
-- Adiciona notas de corte, URLs de capa e subtipos de oportunidade
-- Sprint 7.0 - Pixel Perfect Figma Sync
