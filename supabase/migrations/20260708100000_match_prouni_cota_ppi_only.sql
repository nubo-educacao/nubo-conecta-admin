-- 20260708100000_match_prouni_cota_ppi_only.sql
-- Reproduz calculate_match(uuid) da 20260707190000 com 1 correção de regra de negócio:
--   A cota do ProUni é exclusivamente PPI (dado do MEC: TP_MODALIDADE = AMPLA/PPI).
--   O cota_eligible do ProUni aceitava QUALQUER quota_type declarado (ex.: ESCOLA_PUBLICA
--   ganhava +10 indevidamente). Agora exige overlap com ARRAY['PPI','INDIGENAS'].
