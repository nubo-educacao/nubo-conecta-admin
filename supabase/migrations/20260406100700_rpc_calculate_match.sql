-- 20260406100700_rpc_calculate_match.sql
-- Sprint 3: RPC para calcular match scores de um perfil contra todas as oportunidades
...
BEGIN
    ...
    INSERT INTO public.user_opportunity_matches (profile_id, unified_opportunity_id, match_score, match_details)
    SELECT p_profile_id, b.unified_id, round(b.final_score, 2), b.details
    FROM boosted b
    RETURNING unified_opportunity_id, match_score, match_details;
END;
$$;

COMMENT ON FUNCTION public.calculate_match IS 'RPC: Calcula match scores para um perfil contra v_unified_opportunities. Limpa e regenera todo o set de matches.';
