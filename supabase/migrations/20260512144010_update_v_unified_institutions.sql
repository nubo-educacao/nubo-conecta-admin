-- Migration: update_v_unified_institutions
-- Sprint 8.0: Atualizar view para retornar location via institutionsinfoemec e array de opportunity_type.
...
WITH inst_opps AS (
    SELECT 
        c.institution_id,
        ARRAY_AGG(DISTINCT o.opportunity_type) as opp_types
    FROM campus c
